...
![tomcat]({{ site.baseurl }}/static/img/blog/tomcat-optimize/1.jpg)

看，能够正常显示JDK的版本信息，说明，这个值你能够用。不是说32位系统下最高能够使用2GB内存吗？即：2048m，我们不防来试试

![tomcat]({{ site.baseurl }}/static/img/blog/tomcat-optimize/2.jpg)

可以吗？不可以！不要说2048m呢，我们小一点，试试1700m如何

![tomcat]({{ site.baseurl }}/static/img/blog/tomcat-optimize/3.jpg)
...
![tomcat]({{ site.baseurl }}/static/img/blog/tomcat-optimize/4.jpg)
